...
| 担当         | 内容                               | 担当者 | GitHub ID   |
| :----------- | :--------------------------------- | :----- | :---------- |
| 全体指揮     | コンポーネントのデータ永続化       | K24132 | wappon28dev |
| 画面左側     | ノート一覧・プレビュー機能         | K24064 | rio49k      |
| 画面左側     | ノート種類のトグル機能             | K19117 | kouro0328   |
| 画面右側     | ノート詳細（表示・入力）           | K24009 | uiro0120    |
| Comment view | 画面右側・ノート詳細オプション機能 | K24036 | Okazawa0508 |

## docs

- [仕様書](https://github.com/OOP2-2025-final-G18/BangNote/blob/main/spec/spec.md) --- Loop でみんなで書いた資料
- [PR 指示書](https://github.com/OOP2-2025-final-G18/BangNote/blob/main/spec/pr.md) --- 自分の担当の箇所
- [コードの歩き方](https://github.com/OOP2-2025-final-G18/BangNote/blob/main/frontend/README.md) --- コードの構造, PR の出し方, AI に投げるときのコツ
- [型定義ファイル](https://github.com/OOP2-2025-final-G18/BangNote/blob/main/frontend/types)
