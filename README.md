...
### 4. 保存とエクスポート
* 作成したノートは、**Markdown**, **PDF**, **CSV** の各形式での保存に対応しています。
...
| 担当 | 内容 | 担当者 | GitHub ID |
| :--- | :--- | :--- | :--- |
| 全体指揮 | コンポーネントのデータ永続化 | K24132 町田 渉 | wappon28dev |
| 画面左側 | ノート一覧・プレビュー機能 | K24064 近藤 稟桜 | rio49k |
| 画面左側 | ノート種類のトグル機能 | K19117 渡邉 祐太朗 | kouro0328 |
| 画面右側 | ノート詳細（表示・入力） | K24009 池上 正悟 | uiro0120 |
| 画面右側 | ノート詳細オプション機能 | K24036 岡澤 有真 | Okazawa0508 |
